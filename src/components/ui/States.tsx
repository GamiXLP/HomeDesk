...
export function LoadingState({ rows = 3 }: { rows?: number }) {
  return (
    <div className="space-y-3" aria-label="Lädt">
...
export function EmptyState({
  title = 'Hier ist gerade nichts offen.',
  text,
  action,
}: {
  title?: string;
  ...
  return (
    <Card className="border-red-200 p-6 dark:border-red-900">
      <div className="flex gap-3">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-red-50 text-red-600 dark:bg-red-950/70 dark:text-red-300">
